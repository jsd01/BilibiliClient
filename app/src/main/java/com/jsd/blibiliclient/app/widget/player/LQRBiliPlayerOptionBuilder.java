...
public class LQRBiliPlayerOptionBuilder {
    ...
    // 标准播放器的回调
    protected GSYSampleCallBack mMyStandardVideoAllCallBack;
    ...
    public LQRBiliPlayerOptionBuilder setMyStandardVideoAllCallBack(GSYSampleCallBack myStandardVideoAllCallBack) {
