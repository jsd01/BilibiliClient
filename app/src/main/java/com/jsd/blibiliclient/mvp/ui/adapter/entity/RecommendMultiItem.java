package com.jsd.blibiliclient.mvp.ui.adapter.entity;
...
//    public static final int CONVERGE = 6;// goto：converge（小埋广告，不做）
    ...
    private RecommendIndexData.DataBean indexDataBean;
    ...
    public RecommendIndexData.DataBean getIndexDataBean() {
        return indexDataBean;
    }

    public void setIndexDataBean(RecommendIndexData.DataBean indexDataBean) {
