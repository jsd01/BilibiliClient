...
import com.jsd.blibiliclient.app.widget.AutoSlidingTabLayout;
import com.jsd.blibiliclient.app.widget.player.AppBarStateChangeEvent;
import com.jsd.blibiliclient.app.widget.player.LQRBiliPlayer;
import com.jsd.blibiliclient.app.widget.player.LQRBiliPlayerOptionBuilder;
...
import com.jsd.blibiliclient.mvp.ui.adapter.VideoDetailFragmentAdapter;
...
public class VideoDetailActivity extends BaseSupportActivity<VideoDetailPresenter> implements VideoDetailContract.View {
    ...
    private void initFab() {
        mFab.setOnClickListener(view -> {/*添加FloatingActionButton显示/隐藏的属性动画*/
    ...
    private void initVideoPlayer() {
        ...
        mGsyVideoOptionBuilder = new LQRBiliPlayerOptionBuilder()
                ...
                .setVideoTitle("")
                .setMyStandardVideoAllCallBack(new GSYSampleCallBack() {
                    @Override
